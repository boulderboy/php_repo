...
CREATE TABLE `orders` (
  ...
  `accepted` tinyint(2) DEFAULT NULL,
  `declined` tinyint(2) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `orders` VALUES (3,'admin','{\"3\":{\"quantity\":6,\"price\":\"300\"},\"1\":{\"quantity\":3,\"price\":\"100\"}}','03.02.19',0,1),(4,'admin','{\"3\":{\"quantity\":6,\"price\":\"300\"},\"1\":{\"quantity\":3,\"price\":\"100\"}}','03.02.19',1,0),(5,'admin','{\"3\":{\"quantity\":6,\"price\":\"300\"},\"1\":{\"quantity\":3,\"price\":\"100\"}}','03.02.19',0,1),(6,'admin','{\"2\":{\"quantity\":2,\"price\":\"200\"},\"1\":{\"quantity\":1,\"price\":\"100\"},\"3\":{\"quantity\":1,\"price\":\"300\"}}','03.02.19',1,0),(7,'ivan','{\"3\":{\"quantity\":1,\"price\":\"300\"},\"2\":{\"quantity\":1,\"price\":\"200\"},\"1\":{\"quantity\":1,\"price\":\"100\"}}','05.02.19',0,1),(14,'ivan','{\"2\":{\"quantity\":1,\"price\":\"200\"},\"3\":{\"quantity\":3,\"price\":\"300\"}}','05.02.19',1,0);
...
INSERT INTO `users` VALUES (1,'admin','21232f297a57a5a743894a0e4a801fc3','1',NULL),(2,'user','ee11cbb19052e40b07aac0ca060c23ee','0',NULL),(3,'ivan','202cb962ac59075b964b07152d234b70','0',NULL);
...
-- Dump completed on 2019-02-05 15:35:49
